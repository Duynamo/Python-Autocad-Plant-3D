...
def hotreload(s, L=300.0, D=342.0, T=27.0, H=991.0, H1= 725, D1=355.0, No=8, Dh=19.0, PCD=299.0, F=3.0, G=256.0, **kw):
    try:
        ...
        return ns["run"](s, L=L, D=D, T=T, H=H, H1=H1, D1=D1, No=No, Dh=Dh, PCD=PCD, **kw)
